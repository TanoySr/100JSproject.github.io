...
<head>
  ...
  <style>
    ...
    #tetris   { margin: 1em auto; padding: 1em; border: 4px solid black; border-radius: 10px; background-color: #FF4105; }
    #stats    { display: inline-block; vertical-align: top; }
    #canvas   { display: inline-block; vertical-align: top; background: url(https://storage.needpix.com/rsynced_images/background-4232859_1280.png); box-shadow: 10px 10px 10px #999; border: 2px solid #333; }
